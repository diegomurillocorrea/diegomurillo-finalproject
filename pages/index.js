...
const IndexPage = () => {
    return (
        <div className="w-full">
            ...
            <div className="w-full">
                <div className="flex justify-end fixed w-full -mt-12 ml-28 z-0">
                    <img src="../images/home/hamburgerBg.svg" />
                </div>
                <div className="flex justify-end fixed w-full mt-32 ml-8 z-0">
